...
function SignUp() {
    ...
    const [isErrorResetPassword, setResetErrorPassword] = useState(false);
    ...
    const TakeValueResetPassword = (event) => {
    ...
    const handleSubmit = (event) => {
        ...
        if (isResetPassword.trim() === '') {
            setResetErrorPassword(true);
        } else {
            setResetErrorPassword(false);
        }
    };
    return (
              ...
              <svg className='mx-auto cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="33" height="26" viewBox="0 0 33 26" fill="none">
                ...
                <div className='w-full sm:w-[400px]  rounded-[20px] bg-[#161D2F] p-[32px] mt-[82px]'>
                    ...
                    <form onSubmit={handleSubmit} className='mt-[40px]'>
                        ...
                        <label className='w-full relative' htmlFor="Email">
                            <input value={isResetPassword} onChange={TakeValueResetPassword} id='Email' placeholder='Repeat password' type="text" className={`border-b-[1px] border-b-[#5A698F] pb-[17px] pl-[16px] bg-transparent outline-none text-white w-full  mt-[40px] ${isErrorResetPassword ? "border-b-[#FC4747]" : ""}`} />
                    ...
                    <div className='flex flex-col sm:flex-row items-center justify-center gap-[9px] mt-[24px]'>
                        ...
                        <NavLink to='/login' className='text-[15px] text-[#FC4747] cursor-pointer'>
                            Login
                        </NavLink>
                    </div>
                </div>
