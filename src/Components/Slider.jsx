...
function Slider() {
  ...
  return (
    <section className='px-[24px] sm:px-[0px]'>
            <h1 className='text-3xl sm:text-4xl	 text-white'>
              ...
              >
                  ...
                  <SwiperSlide key={item.id}>
                    <div 
                     className=' card__slider w-[340px] h-[140px] sm:w-[470px] sm:h-[230px] rounded-md bg-cover bg-center relative cursor-pointer' >
                      <div className='slider_card absolute inset-0 flex items-center justify-center'  style={{ backgroundColor: 'rgba(0, 0, 0, 0.534)' }}>
                        <button className='flex items-center gap-5 p-2.5 pr-5'
                          style={{
                            borderRadius: '28.5px',
