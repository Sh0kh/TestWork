...
function Header() {
  ...
  return (
    <header className="block md:hidden w-full  px-[20px] py-[25px] bg-[#161D2F] rounded-lg mb-[24px] sm:mb-[34px]  ">
      ...
      <nav className="flex items-center gap-[32px]">
        <NavLink className={`text-[#5A698F]`} to="/">
          <svg
            class={`${
              Home ? "text-white" : ""
            } "w-4 h-4 sm:w-5 sm:h-5 hover:text-red-500"`}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
          >
            <path
        ...
        <NavLink className={`text-[#5A698F]`} to="/movies">
          <svg
            className={`" hover:text-red-500 w-4 h-4 sm:w-5 sm:h-5" ${
              Movies ? "text-white" : ""
            }`}
            xmlns="http://www.w3.org/2000/svg"
            width="20"
